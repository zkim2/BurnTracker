...
class userSummaryFrame(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		self.profileNameLabel = tk.Label(self,text=self.profileName, font=("Helvetica", 15))
		self.profileNameLabel.grid(row=1,column=0,sticky="nsew")

		self.profileAge = "Age: " + str(self.controller.userProfile.age)
		self.profileAgeLabel = tk.Label(self,text=self.profileAge, font=("Helvetica",15))
		...
		self.profileWeightLabel = tk.Label(self,text=self.profileWeight, font=("Helvetica",15))
		...
		self.profileHeightLabel = tk.Label(self,text=self.profileHeight, font=("Helvetica",15))
		...
		self.profileGWeightLabel = tk.Label(self,text=self.profileGWeight, font=("Helvetica",15))
		...
		self.profileActLvlLabel = tk.Label(self,text=self.profileActLvl, font=("Helvetica",15))
		...
		self.profileDeficitLabel = tk.Label(self,text=self.profileDeficit, font=("Helvetica",15))
		...
		self.profileCurrWeightLabel = tk.Label(self,text=self.profileCurrWeight, font=("Helvetica",15))
		...
		self.profileWeightLostLabel = tk.Label(self,text=self.profileWeightLost, font=("Helvetica", 15))
		...
		self.profileBMRLabel = tk.Label(self,text=self.profileBMR,font=("Helvetica",15))
		...
		self.profileCaloriesLabel= tk.Label(self,text=self.profileCalories,font=("Helvetica",15))
		...
		self.profileTimeLabel = tk.Label(self,text=self.profileTime, font=("Helvetica",15))
		...
		self.profileAdviceLabel = tk.Label(self,text=self.profileAdvice, font=("Helvetica",15))
