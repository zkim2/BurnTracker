...
class modifyCaloricDeficitFrame(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		self.modifyIntensityLabel = tk.Label(self,text="What is your new caloric deficit?", font=("Helvetica", 25),bg="#586BE4")
		...
		self.modifyIntensityEntry = tk.Entry(self,textvariable=self.intensityVar ,font=("Helvetica", 20),bd=0)
