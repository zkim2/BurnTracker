...
class deleteCalorieFrame(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		self.deleteCalorieLabel = tk.Label(self,text="Deleting Calories", font=("Helvetica", 25))
		...
		self.dateToDelete= tk.Label(self,text="Date of calories(MM/DD/YY):", font=("Helvetica", 20))
