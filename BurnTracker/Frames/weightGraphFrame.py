...
class weightGraphFrame(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		sortedData = sorted(self.controller.userProfile.weightData.items(), key = lambda d: d[0])
		x,y = zip(*sortedData)
		a.plot(x,y)
		a.set_ylabel('Weight(lbs)')
		...
		toolbar.update()
		canvas._tkcanvas.grid(row=2,column=1,sticky="nsew")
		"""
