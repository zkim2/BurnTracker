...
class deleteWeightFrame(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		self.deleteWeightLabel = tk.Label(self,text="Deleting Weight", font=("Helvetica", 25),bg="#586BE4")
		...
		self.dateToDelete= tk.Label(self,text="Date to delete(MM/DD/YY):", font=("Helvetica", 20),bg="#586BE4")
