...
class mainMenuFrame(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		self.addDailyWeightButton = tk.Button(self,text="Add daily weight",font = ("Helvetica", 15), width=20)
		...
		self.addDailyCaloriesButton = tk.Button(self,text="Add daily calories",font = ("Helvetica", 15),width=20)
		...
		self.visualizeProgressButton = tk.Button(self,text="Visualize progress",font = ("Helvetica", 15),width=20)
		...
		self.updateProfileButton = tk.Button(self,text="Update your profile",font = ("Helvetica", 15),width=20)
