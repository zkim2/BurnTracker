...
class calorieSubMenuFrame(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		self.whatToChangeLabel = tk.Label(self, text="What do you want to do with your caloric data?", font=("Helvetica",25),bg="#586BE4")
		self.whatToChangeLabel.grid(row=0,column=1,sticky="nsew")


		self.deleteCalorieButton = tk.Button(self,text="Delete calories of a specific date", width=40, font=("Helvetica", 15),highlightbackground="#586BE4")
		self.deleteCalorieButton.bind("<Button-1>", self.controller.sendToDeleteCalories)
		self.deleteCalorieButton.grid(row=1,column=1)

		self.modifyCalorieButton = tk.Button(self,text="Modify calories of a specific date", width=40, font=("Helvetica", 15),highlightbackground="#586BE4")
