...
class deleteWeightFrame(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		self.deleteWeightLabel = tk.Label(self,text="Deleting Weight")
		self.deleteWeightLabel.grid(row=0,column=0, sticky="nsew")

		self.success = tk.Label(self,text="")
		self.success.grid(row=0,column=1,sticky="nsew")


		self.dateToDelete= tk.Label(self,text="Date of weight to delete(MM/DD/YY):")
