...
class visualizeProgressFrame(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		self.whichVisualizationLabel = tk.Label(self,text="Which graph would you like to see?", font=("Helvetica", 20))
		...
		self.weightGraphButton.grid(row=1,column=1,sticky="nsew")
		...
		self.calorieGraphButton.grid(row=2,column=1,sticky="nsew")
